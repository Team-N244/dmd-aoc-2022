...
DaySix solver6 = new(fileLines);

Console.WriteLine("Part One: " + solver6.Solve(1)); // solution for part 1
Console.WriteLine("Part Two: " + solver6.Solve(2)); // solution for part 2
